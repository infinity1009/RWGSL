...
def get_args():
    ...
    parser.add_argument('--separate_1', type=int, default=3,
                        help="degree threshold 1")
    parser.add_argument('--separate_2', type=int, default=8,
                        help="degree threshold 2")
    parser.add_argument('--coefficient', type=float,
                        default=0.6, help="coefficient in sampling")
    parser.add_argument('--noise', type=str,
                        default="add_delete", help='how to inject noise')
